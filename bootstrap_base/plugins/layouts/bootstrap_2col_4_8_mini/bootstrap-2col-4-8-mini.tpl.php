  ...
  <?php if ($content['left'] || $content['right']): ?>
    <section class="panel-main row-fluid clearfix">
    	<?php if ($content['left'] && $content['right']): ?>
	        ...
	        <section class="span8 panel-right"><?php print $content['right']; ?></section>
        <?php elseif (!$content['left']): ?>
        	<section class="span12 panel-right"><?php print $content['right']; ?></section>
        <?php else: ?>
        	<section class="span12 panel-left"><?php print $content['left']; ?></section>
         <?php endif ?>
    </section>
  <?php endif ?>
