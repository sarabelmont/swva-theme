(function(template, osmplayer) {
  ...
  osmplayer[template].prototype.loadNode = function(node) {
	  ...
	  this.elements.desc.text(node.desc);
	  this.elements.body.text(node.body);
	  this.elements.tagline.text(node.tagline);
  };
  ...
  osmplayer[template].prototype.getElements = function() {
    ...
    return jQuery.extend(elements, {
	  ...
	  tagline: jQuery('#mediaplayer_tagline', this.display),
	  desc: jQuery('#mediaplayer_desc', this.display),
	  body: jQuery('#mediaplayer_body', this.display),
      minplayer: minplayer,
